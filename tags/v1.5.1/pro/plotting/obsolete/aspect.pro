...
;
; PURPOSE:
;  Returns the normalized position coordinates necessary to put a plot with a specified aspect ratio into the currently active graphics window.  
;
;  It works on the display output window as well as in a PostScript output
;  window.
;
; AUTHOR:
;
...
IF N_ELEMENTS(margin) EQ 0 THEN margin = 0.075
