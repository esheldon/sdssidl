function histogram_2d,x,y,nxbins,nybins,xrange=xrange,yrange=yrange,silent=silent
...
;CALLING SEQUENCE:
;
;	-syntax hist=histogram_2d(x,y,hist,nxbins,nybins,xrange=,yrange=,silent=silent)
;
;INPUTS:
...
if n_params() lt 3 then begin
	print,'-syntax hist = histogram_2d(x,y,nxbins,nybins,xrange=,yrange=,/silent)'
    on_error, 2
    message,'Halting'
endif
